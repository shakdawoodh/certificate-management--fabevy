      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> <a href="update-course.php ?id=<?php echo$row['id'];?>"><i class="fas fa-pencil-alt"></i></a>    <a href="delete-student.php ?id=<?php echo$row['id'];?>" onclick="checkdelete(<?php echo $row['id'];?>);"><i class="fas fa-trash-alt"></i></a></td> 
          </tr>
          <?php } ?>
